...
## Purpose
The Settings capability provides a unified configuration interface for API key management and default model selection for translation and script enhancement, serving as the central hub for application preferences.
## Requirements
