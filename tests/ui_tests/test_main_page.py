...
class TestMainPage:
    ...
    def test_page_loads(self, configured_page: Page, streamlit_server: str):
        ...
        # Check main heading
        expect(
            configured_page.get_by_role("heading", name="ElevenTools")
        ).to_be_visible()
    ...
    def test_voice_settings_expander(
        self, configured_page: Page, streamlit_server: str
    ):
    ...
    def test_generate_button_present(
        ...
        generate_button = configured_page.get_by_role(
            "button", name=re.compile(r"Generate Audio", re.IGNORECASE)
        )
    ...
    def test_variable_detection_display(
        self, configured_page: Page, streamlit_server: str
    ):
